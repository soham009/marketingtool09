...
class Leads(models.Model):
    ...
    Login_Time_id = models.ForeignKey(Login_Time, on_delete = models.CASCADE,related_name = 'pickup_location')
...
class Lead_Comment(models.Model):
    ...
    lead_comment_updated_by =models.ForeignKey(CustomUser,on_delete= models.CASCADE)
...
class Company_Leads(models.Model):
    ...
    company_leads_designation=models.CharField(max_length=264,default='')
...
class Company_Leads_Comment(models.Model):
	...
	company_lead_comment_updated_by =models.ForeignKey(CustomUser,on_delete= models.CASCADE)
